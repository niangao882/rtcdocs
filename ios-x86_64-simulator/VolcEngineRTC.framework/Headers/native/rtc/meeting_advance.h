...
struct SubscribeVideoBaseline {
    /**
     * 
     * @brief 网络等级判定为优秀的视频宽/高中小值的基线，-1 表示业务不设置计算时忽略此参数
     */
    ...
    /**
     * 
     * @brief 网络等级判定为差视频宽/高中小值的基线，-1 表示业务不设置计算时忽略此参数
     */
    ...
    /**
     * 
     * @brief 业务可以接受的最小分辨率高度，-1 表示业务忽略此参数
     */
...
namespace bytertc {
     ...
     * @param  [char*] params carsh 参数信息的 json 形式的字符数组
     * @param  [int] size 用于存储 params 信息的数组大小
     */
    ...
    /**
     *@hidden
     *@brief 获取 EffectSDK 版本，用于初始化 platformsdk
     */
