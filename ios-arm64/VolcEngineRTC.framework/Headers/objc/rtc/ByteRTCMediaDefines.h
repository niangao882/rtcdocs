...
typedef NS_ENUM(NSInteger, ByteRTCRoomProfile) {
    ...
    /**
     * 
     * @brief 适用于 VR 场景。支持最高 192 KHz 音频采样率，可开启球形立体声。345 之后支持
     */
...
typedef NS_ENUM(NSInteger, ByteRTCErrorCode) {
    ...
    /**
     * 
     * @brief 没有发布音视频流权限。通过 rtcRoom:onStreamStateChanged:withUid:state:extraInfo:{@link #ByteRTCRoomDelegate#rtcRoom:onStreamStateChanged:withUid:state:extraInfo:} 回调。 <br>
    ...
    /**
     * 
     * @brief 没有订阅音视频流权限。通过 rtcRoom:onStreamStateChanged:withUid:state:extraInfo:{@link #ByteRTCRoomDelegate#rtcRoom:onStreamStateChanged:withUid:state:extraInfo:} 回调。 <br>
    ...
    /**
     * 
     * @brief 当调用 `createRtcRoom:` ，如果 roomId 非法，会返回 null，并抛出该错误。通过 rtcEngine:onCreateRoomStateChanged:errorCode:{@link #ByteRTCVideoDelegate#rtcEngine:onCreateRoomStateChanged:errorCode:} 回调。
     */
    ...
    /**
     * 
     * @brief 通话回路检测已经存在同样 roomId 的房间了。通过 rtcEngine:onCreateRoomStateChanged:errorCode:{@link #ByteRTCVideoDelegate#rtcEngine:onCreateRoomStateChanged:errorCode:} 回调。
     */
    ...
    /**
     * 
     * @brief 订阅音视频流失败，订阅音视频流总数超过上限。通过 rtcRoom:onStreamStateChanged:withUid:state:extraInfo:{@link #ByteRTCRoomDelegate#rtcRoom:onStreamStateChanged:withUid:state:extraInfo:} 回调。 <br>
    ...
    /**
     * 
     * @brief 发布流失败，发布流总数超过上限。通过 rtcRoom:onStreamStateChanged:withUid:state:extraInfo:{@link #ByteRTCRoomDelegate#rtcRoom:onStreamStateChanged:withUid:state:extraInfo:} 回调。 <br>
     ...
     *        通过 rtcRoom:onStreamStateChanged:withUid:state:extraInfo:{@link #ByteRTCRoomDelegate#rtcRoom:onStreamStateChanged:withUid:state:extraInfo:} 回调。
     */
...
typedef NS_ENUM(NSInteger, ByteRTCWarningCode) {
    ...
    /**
     * 
     * @brief 发布音视频流失败。通过 rtcRoom:onStreamStateChanged:withUid:state:extraInfo:{@link #ByteRTCRoomDelegate#rtcRoom:onStreamStateChanged:withUid:state:extraInfo:} 回调。 <br>
    ...
    /**
     * 
     * @brief 订阅音视频流失败。通过 rtcRoom:onStreamStateChanged:withUid:state:extraInfo:{@link #ByteRTCRoomDelegate#rtcRoom:onStreamStateChanged:withUid:state:extraInfo:} 回调。 <br>
    ...
    /**
     * 
     * @brief 当调用 `setUserVisibility:` 将自身可见性设置为 false 后，再尝试发布流会触发此警告。通过 rtcRoom:onStreamStateChanged:withUid:state:extraInfo:{@link #ByteRTCRoomDelegate#rtcRoom:onStreamStateChanged:withUid:state:extraInfo:} 回调。
     */
    ...
    /**
     * 
     * @brief 用户已经在其他房间发布过流，或者用户正在发布公共流。通过 rtcRoom:onStreamStateChanged:withUid:state:extraInfo:{@link #ByteRTCRoomDelegate#rtcRoom:onStreamStateChanged:withUid:state:extraInfo:} 回调。
     */
    ...
    /**
     * 
     * @brief 已存在相同 roomId 的房间，新创建的房间实例已替换旧房间实例。通过 rtcRoom:onRoomStateChanged:withUid:state:extraInfo:{@link #ByteRTCRoomDelegate#rtcRoom:onRoomStateChanged:withUid:state:extraInfo:} 回调。
     */
...
typedef NS_ENUM(NSInteger,  ByteRTCSEIStreamEventType) {
     ...
     *        - 远端用户调用 sendSEIMessage:andMessage:andRepeatCount:andCountPerFrame:{@link #ByteRTCVideo#sendSEIMessage:andMessage:andRepeatCount:andCountPerFrame:} 后 1min 内未有 SEI 数据发送，黑帧视频流停止发布；
...
typedef NS_ENUM(NSInteger, ByteRTCColorSpace) {
    ...
    /**
     * 
     *  @brief BT.601 数字编码标准，颜色空间[0-255]
     */
 ...
 *            - 若使用自定义采集，此时你需调用 pushExternalAudioFrame:{@link #ByteRTCVideo#pushExternalAudioFrame:} 将采集到的音频推送给 SDK
 *        - false：否
 */
 ...
 *            - 若使用自定义采集，此时你需调用 pushExternalVideoFrame:{@link #ByteRTCVideo#pushExternalVideoFrame:} 将采集到的视频推送给 SDK
 *        - false：否
